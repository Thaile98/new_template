...
<head>
	...
	@if($detect->isMobile())
		<style>
			<?php $style = file_get_contents('css/main_search_job-mobile.css');echo $style;?>
		</style>
	@else 
		<style>
			...
			<div class="block">
				<div class="row no-gape">
					<div class="search__job-aside col-3">
						...
						@include('component.web.aside_widget')
					</div>
					<div class="search__job-listing col-6 column">
						...
						<div class="job__list">
							@for($i=1;$i<=10;$i++) 
								@include( 'component.web.job_list_item') 
							@endfor
						</div>
