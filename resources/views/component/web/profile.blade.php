<div class="profile__header">
	...
	<div class="profile__header-btn-dropdown"> 
		<span> 
			<img class="lazy" data-original="uploads/none-user.jpg" src="uploads/giphy.gif" onerror=" this.src='/images/none-user.jpg'" alt="Thái Lê">&nbsp;
			<div class="profile_header-user-name">Thái Lê</div> 
		</span>
		<ul>
			<li>
				<a href="#" class="signup-popup" data-url-render="https://123job.vn/ajax/render_form_register"> <i class="la la-file-text"></i> Đăng ký</a>
			</li>
			<li>
			...
			<li>
				<a href="https://123job.vn/nguoi-tim-viec/dang-xuat"><i class="la la-sign-out"></i> Đăng xuất </a>
			</li>
		</ul>
	</div>
