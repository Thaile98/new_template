...
<head>
	...
	@if($detect->isMobile())
		<style>
			<?php $style = file_get_contents('css/main_home-mobile.css');echo $style;?>
		</style>
	@else 
		<style>
...
<body>
	@if($detect->isMobile())
		@include('component.mobile.header-mobile')
		@include('component.mobile.form_search_content-mobile')
		@include('component.mobile.career_category-mobile')
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card" style="margin-bottom: 0 !important">
								...
								<div class="card-body">
									<div class="row">
											@include('component.mobile.job_box-mobile')
									</div>
								</div>
							</div>
						</div>
		...
		@include('component.mobile.job_favorite_box-mobile')
		@include('component.mobile.box_mobile_sidebar')
		@include('component.mobile.footer-mobile')
	@else 
							...
							<div class="main-featured-sec">
								...
								<div class="job-search-sec">
									<div class="job-search">
										...
										@include('component.web.form_search_banner')
		...
		<section id="scroll-here">
			<div class="block">
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-lg-mobile">
							<div class="heading">
							...
							<div class="cat-sec cat-sec-desctop">
								<div class="row no-gape">
									...
									@include('component.web.career_category_top')
							...
							<div class="cat-sec cat-sec-desctop">
								<div class="row no-gape">
									...
									@include('component.web.career_category_end')
							...
							<div class="tab__title mt-3 mb-3">
								<ul class="tab__title-list" role="tablist">
									<li class="tab__title-list-item text-center no-padding active">
										<a href="">
											<h3 class="no-padding no-margin">VIỆC LÀM TỐT NHẤT</h3>
										</a>
									</li>
									<li class="tab__title-list-item text-center no-padding">
										<a href="">
											<h3 class="no-padding no-margin">VIỆC LÀM HOT</h3>
										</a>
									</li>
								</ul>
							</div>
							...
							<div class="w-100 float-left">
								<div class="w-50 float-left">
									<div class="card d-flex">
										<div class="card-body">
											<div class="row">
												@include('component.web.job_box_home')
											</div>
										</div>
									</div>
								</div>
				...
				<div class="job__category">
					<div class="w-50 float-left pl-2">
						...
						<div class="link-view-all">
							<a href="" class="text-info" title="Xem tất cả ngành nghề">Xem tất cả ngành nghề <i class="fa fa-arrow-circle-right"></i>
	                        </a>
						</div>
					</div>
					<div class="w-50 float-left pl-2 ">
						...
						<div class="link-view-all"> 
							<a href="" class="text-info" title="Xem tất cả khu vực">Xem tất cả khu vực <i class="fa fa-arrow-circle-right"></i>
	                        </a>
						</div>
					</div>
				</div>
